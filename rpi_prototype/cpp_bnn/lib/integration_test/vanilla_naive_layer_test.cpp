...
int main(int argc, char * argv[]) {
    ...
    if (EPOCH != 0) {
        ...
        layer_seq[0] = std::make_unique<Vanilla_Convolution2D>(32, 3, "same", true, 0);
        ...
        layer_seq[3] = std::make_unique<Vanilla_Convolution2D>(32, 3, "same", false, 1);
        ...
        layer_seq[8] = std::make_unique<Vanilla_BNNDense>(64, false, 0);
        ...
        layer_seq[11] = std::make_unique<Vanilla_BNNDense>(64, false, 1);
        ...
        layer_seq[14] = std::make_unique<Vanilla_BNNDense>(10, false, 2);
