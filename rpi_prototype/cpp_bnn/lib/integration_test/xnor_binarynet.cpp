...
int main(int argc, char * argv[]) {
    ...
    layer_seq.push_back(std::make_unique<XNor_Convolution2D>(128, 3, "same", true, 0));
    ...
    layer_seq.push_back(std::make_unique<XNor_Convolution2D>(128, 3, "same", false, 1));
    layer_seq.push_back(std::make_unique<MaxPooling<bool>>(2, 2));
    layer_seq.push_back(std::make_unique<XNor_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<bool>>());
    
    layer_seq.push_back(std::make_unique<XNor_Convolution2D>(256, 3, "same", false, 2));
    layer_seq.push_back(std::make_unique<XNor_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<bool>>());
    layer_seq.push_back(std::make_unique<XNor_Convolution2D>(256, 3, "same", false, 3));
    layer_seq.push_back(std::make_unique<MaxPooling<bool>>(2, 2));
    layer_seq.push_back(std::make_unique<XNor_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<bool>>());
    
    layer_seq.push_back(std::make_unique<XNor_Convolution2D>(512, 3, "same", false, 4));
    layer_seq.push_back(std::make_unique<XNor_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<bool>>());
    layer_seq.push_back(std::make_unique<XNor_Convolution2D>(512, 3, "same", false, 5));
    layer_seq.push_back(std::make_unique<MaxPooling<bool>>(2, 2));
    layer_seq.push_back(std::make_unique<XNor_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<bool>>());
    ...
    layer_seq.push_back(std::make_unique<XNor_Dense>(1024, false, 0));
    layer_seq.push_back(std::make_unique<XNor_BatchNormDense>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<bool>>());
    
    layer_seq.push_back(std::make_unique<XNor_Dense>(1024, false, 1));
    layer_seq.push_back(std::make_unique<XNor_BatchNormDense>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<bool>>());
