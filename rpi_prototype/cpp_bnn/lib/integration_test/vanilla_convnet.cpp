...
int main(int argc, char * argv[]) {
    ...
    layer_seq.push_back(std::make_unique<Vanilla_Convolution2D>(64, 3, "valid", true, 0));;
    ...
    layer_seq.push_back(std::make_unique<Vanilla_Convolution2D>(64, 3, "valid", false, 1));;
    layer_seq.push_back(std::make_unique<Vanilla_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<float>>());
    layer_seq.push_back(std::make_unique<MaxPooling<float>>(2, 2));
    
    layer_seq.push_back(std::make_unique<Vanilla_Convolution2D>(128, 3, "valid", false, 2));;
    layer_seq.push_back(std::make_unique<Vanilla_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<float>>());
    layer_seq.push_back(std::make_unique<Vanilla_Convolution2D>(128, 3, "valid", false, 3));;
    layer_seq.push_back(std::make_unique<Vanilla_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<float>>());
    layer_seq.push_back(std::make_unique<MaxPooling<float>>(2, 2));
    
    layer_seq.push_back(std::make_unique<Vanilla_Convolution2D>(256, 3, "valid", false, 4));;
    layer_seq.push_back(std::make_unique<Vanilla_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<float>>());
    layer_seq.push_back(std::make_unique<Vanilla_Convolution2D>(256, 3, "valid", false, 5));;
    layer_seq.push_back(std::make_unique<Vanilla_BatchNormConv>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<float>>());
    
    layer_seq.push_back(std::make_unique<Flatten>());
    
    layer_seq.push_back(std::make_unique<Vanilla_BNNDense>(512, false, 0));
    layer_seq.push_back(std::make_unique<Vanilla_BatchNormDense>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<float>>());
    
    layer_seq.push_back(std::make_unique<Vanilla_BNNDense>(512, false, 1));
    layer_seq.push_back(std::make_unique<Vanilla_BatchNormDense>(BATCH_NORM_MOMENTUM));
    layer_seq.push_back(std::make_unique<BinaryActivation<float>>());
