...
void test_speed_DenseNotFirst(const int size) {
    ...
    Vanilla_Dense_OVW test_dense(size);
...
void test_DenseFirst() {
    ...
    Vanilla_Dense_OVW test_dense(4, true);
...
void test_DenseNotFirst() {
    ...
    print_mat(test_input);
    Vanilla_Dense_OVW test_dense(4, false, 0);
...
void test_DenseNotFirst_1D() {
    ...
    printf("Test Dense(is not first)\n");
    print_mat(test_input);
    Vanilla_Dense_OVW1D test_dense(4, false, 0);
...
void test_DenseNotFirst_1D_2() {
    Matrix<float> test_input({2, 5});
    Matrix<float> test_output;
    Matrix<float> test_output_backprop;
    glorot_normal_initializer<float>(test_input);
    printf("\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n");
    printf("Test Dense(is not first) 2\n");
    print_mat(test_input);
    Vanilla_Dense_OVW1D test_dense(4, false, 0);
...
void test_DenseFirst_1D() {
    ...
    printf("Test Dense(is first)\n");
    print_mat(test_input);
    Vanilla_Dense_OVW1D test_dense(4, true, 0);
        ...
        case 0:
            {
                ...
                //test_DenseNotFirst();
                //test_DenseFirst();
                test_DenseNotFirst_1D();
                test_DenseNotFirst_1D_2();
                //test_DenseFirst_1D();
            }
            break;
