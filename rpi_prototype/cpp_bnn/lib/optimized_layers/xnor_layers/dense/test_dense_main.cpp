...
void test_speed_DenseNotFirst(const int size) {
    ...
    OPT_XNor_Dense test_dense(size);
...
void test_DenseFirst() {
    ...
    OPT_XNor_Dense test_dense(4, true);
    ...
    glorot_normal_initializer<float16_t>(test_input); // get back original input
    auto start_2 = std::chrono::high_resolution_clock::now();
...
void test_DenseNotFirst() {
    ...
    print_mat(test_input);
    OPT_XNor_Dense test_dense(4, false, 0);
