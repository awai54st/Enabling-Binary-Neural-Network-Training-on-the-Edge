...
#include "../po2_layers/xnor_layers/dense/xnor_dense_po2.h"
...
void ovw1d_xnor_model(int BATCH_SIZE, int EPOCH) {
    ...
    if (EPOCH > 0) {
        ...
        layer_seq.push_back(std::make_unique<XNor_Dense_PO2>(256, true, 0));
        ...
        layer_seq.push_back(std::make_unique<XNor_Dense_PO2>(256, false, 1));
        layer_seq.push_back(std::make_unique<XNor_BatchNormDense<Matrix, Matrix<float16_t>&>>(BATCH_NORM_MOMENTUM));
        layer_seq.push_back(std::make_unique<BinaryActivation<bool, Matrix, float16_t, Matrix<float16_t>&>>());

        layer_seq.push_back(std::make_unique<XNor_Dense_PO2>(256, false, 2));
        layer_seq.push_back(std::make_unique<XNor_BatchNormDense<Matrix, Matrix<float16_t>&>>(BATCH_NORM_MOMENTUM));
        layer_seq.push_back(std::make_unique<BinaryActivation<bool, Matrix, float16_t, Matrix<float16_t>&>>());

        layer_seq.push_back(std::make_unique<XNor_Dense_PO2>(256, false, 3));
        layer_seq.push_back(std::make_unique<XNor_BatchNormDense<Matrix, Matrix<float16_t>&>>(BATCH_NORM_MOMENTUM));
        layer_seq.push_back(std::make_unique<BinaryActivation<bool, Matrix, float16_t, Matrix<float16_t>&>>());

        layer_seq.push_back(std::make_unique<XNor_Dense_PO2>(10, false, 4));
        layer_seq.push_back(std::make_unique<XNor_BatchNormDense<Matrix, Matrix<float16_t>&>>(BATCH_NORM_MOMENTUM));
